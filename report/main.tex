...
\begin{document}
	...
	calculated on CASP8-CASP12. So, this appears to be the main problem there, comparing to the fact that raw data tooks only
	...
	\begin{center}
		\begin{table}[h]
			...
			SCN        &        &     &        &        
		\end{tabular}
		\caption{Comparsion of Pearson, Spearman and Kendell correlation coefficients and z-score of the state-of-the-art algorithms,
